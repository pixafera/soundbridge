...
Public Class TcpSoundbridgeClient
   Implements Pixa.Soundbridge.Library.ISoundbridgeClient, System.IDisposable
...
#Region " Debug Client Number "
   Private Shared _nextNumber As Integer = 1
   Private Shared _nextNumberLock As New Object()

   Public Shared Function GetNextNumber() As Integer
      SyncLock _nextNumberLock
         Dim i As Integer = _nextNumber
         _nextNumber += 1
         Return i
      End SyncLock
   End Function
...
#Region " Display Control Commands "
   ...
   <RcpSubscriptionCommand("DisplayUpdateEventSubscribe", "OnDisplayUpdate")> _
...
#Region " Media Servers "
   ...
   <RcpTransactedCommand("GetServerCapabilities")> _
...
#Region " Intiating Media Playback "
   ...
   Public Function NowPlayingInsert() As String Implements ISoundbridgeClient.NowPlayingInsert
      Return NowPlayingInsert(-1, -1)
   End Function

   Public Function NowPlayingInsert(ByVal insertIndex As Integer) As String Implements ISoundbridgeClient.NowPlayingInsert
